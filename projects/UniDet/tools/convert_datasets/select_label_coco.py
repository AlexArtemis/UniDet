...
'''
# 原coco数据集的路径
dataDir = '/home/leizehua/workspace/data/coco2017'
# 用于保存新生成的数据的路径
savepath = "/home/leizehua/workspace/data/coco2017/labels/"
# 最后生产的json文件的保存路径
...
classes_names = ['bicycle', 'bus', 'car', 'motorcycle', 'person', 'truck']
...
def save_json_data(json_file, classes_list, image_info_list, anns_list):
    ...
    coco_sub['info']['year'] = 2021
    coco_sub['info']['contributor'] = 'lzh'
    coco_sub['info']['date_created'] = '2021-3-25'
    sub_license = dict()
