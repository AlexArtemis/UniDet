...
def parse_args():
    ...
    parser.add_argument(
        '-d', '--datadir', help="dir to widerface", default='/home/leizehua/workspace/data/WiderFace/', type=str)

    parser.add_argument(
        '-s', '--subset', help="which subset to convert", default='all', choices=['all', 'train', 'val'], type=str)

    parser.add_argument(
        '-o', '--outdir', help="where to output the annotation file, default same as data dir",
        default='/home/leizehua/workspace/data/widerface_coco')
